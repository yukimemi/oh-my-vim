...
if s:is_darwin
    if has("gui_running")
        ...
        nnoremap <LocalLeader>r :<C-u>set nofullscreen<CR>
        nnoremap <LocalLeader>x :<C-u>set fullscreen<CR>
    endif
elseif s:is_windows
    if has("gui_running")
        " initiallize size
        set lines=130
        set columns=120
        nnoremap <LocalLeader>r :<C-u>simalt ~r<CR>
        nnoremap <LocalLeader>x :<C-u>simalt ~x<CR>
